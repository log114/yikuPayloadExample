...
import com.yiku.yikupayloadSDK.protocol.FOURINONE2_STATE
...
class FourInOne2LightWeight(context: Context, attr: AttributeSet?, defStyleAttr: Int) :
    LinearLayout(context, attr, defStyleAttr) {
    constructor(context: Context, attr: AttributeSet?) : this(context, attr, 0)
    constructor(context: Context) : this(context, null, 0)

    private val TAG = "FourInOne2LightWeight"
    ...
    init {
        initView(context)
        // 消息订阅
        fourInOne2Service.registMainMsgCallback(object : MsgCallback {
            ...
            override fun onMsg(msg: ByteArray) {
                ...
                if (msg[2] == FOURINONE2_STATE.toByte()) {
        ...
        lightSwitchBtn.setOnClickListener {
            ...
            fourInOne2Service.openLight(!isOpenLight)
            thread {
                Thread.sleep(2000)
        ...
        flashSwitchBtn.setOnClickListener {
            ...
            fourInOne2Service.flashSwitch(!isFlashing)
            thread {
                Thread.sleep(2000)
                val handler = Handler(Looper.getMainLooper())
                handler.post {
        ...
        luminanceSeekBar.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
            ...
            override fun onStopTrackingTouch(seekBar: SeekBar) {
                fourInOne2Service.luminanceChange(seekBar.progress)
        ...
        redAndBlueBtn.setOnClickListener {
            ...
            if(isOpenRedAndBlue) {
                ...
                fourInOne2Service.redBlueLedControl(0)
            }
            // 未打开，打开
            else {
                redAndBlueBtn.setText(R.string.close)
                fourInOne2Service.redBlueLedControl(redAndBlueMode.toByte())
            }
    ...
    private fun initView(context: Context?) {
        LayoutInflater.from(context).inflate(R.layout.four_in_one_2_light_weight, this, true)
    ...
    private fun setConnectState() {
        ...
        val task = object : TimerTask() {
            override fun run() {
                // 如果没连接灯，尝试连接
                if(!fourInOne2Service.getMainIsConnected() && !isConnectingMain) {
                    ...
                    thread {
                        Thread.sleep(5000)
                        while (!fourInOne2Service.mainConnect()) {
                            Thread.sleep(1000)
                        }
                        handler.post {
                ...
                if (fourInOne2Service.getMainIsConnected()) {
                    ...
                    if (Date().time - updateTime > 10000) {
                        // 断连
                        fourInOne2Service.mainDisConnect()
                    }
                }
            }
        }
